...
What kind of a MIPS is this?
    ...
    This directory contains the source for a multicycle mini MIPS (mmMIPS) described
    in Patterson and Hennessy in section 5.5. The block diagram is shown in Fig.
    5.28 of the book. A decoder is added to this. This decoder splits the 
...
What program does 'mips.ram' contain?
